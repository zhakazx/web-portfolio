...
import { AnimatedSection, StaggerContainer, StaggerItem, FadeIn, ScaleIn } from '@/components/animations'
    ...
    <section id="about" className="py-12">
      <div className="max-w-4xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Photo */}
          <FadeIn direction="left" className="flex justify-center lg:justify-start order-1 lg:order-2">
            <ScaleIn delay={0.2}>
